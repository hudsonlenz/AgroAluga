...
cat > /tmp/update_categories.py << 'EOF'
with open('src/contexts/AppContext.tsx', 'r') as f:
    content = f.read()

old = '''const CATEGORIES = ["Aluguel de Trator","Colheitadeira","Plantadeira","Pulverizador / Defensivos","Transporte de Graos","Manutencao de Implementos","Irrigacao","Operador + Maquina","Outros Servicos"];'''

new = '''export const EQUIPMENT_CATEGORIES = [
...
print("Done")
EOF
python3 /tmp/update_categories.py