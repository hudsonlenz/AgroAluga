          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="relative">
              ...
              <div className="flex gap-1">
                ...
                <Button variant="outline" size="icon" className="h-9 w-9 shrink-0" onClick={handleGPS} disabled={locating} title="Usar minha localização">
      ...
      <section className="py-4">
        <div className="container mx-auto px-4 flex items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground">{filtered.length}</strong> anúncio{filtered.length !== 1 ? "s" : ""} encontrado{filtered.length !== 1 ? "s" : ""}
